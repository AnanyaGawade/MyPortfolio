  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative px-8">
      ...
      <div className="text-center z-10 content-slip">
        ...
        <h1 className="text-5xl md:text-8xl lg:text-[9rem] font-bold mb-8 tracking-tighter leading-tight bg-gradient-to-r from-white via-white to-blue-500 bg-clip-text text-transparent uppercase text-center">
          {PROFILE.name}
        </h1>
        
        <div className="max-w-xl mx-auto">
          <p className="text-slate-400 text-xl md:text-2xl font-light leading-relaxed tracking-tight">
            {PROFILE.shortBio}
          </p>
        </div>
      </div>
